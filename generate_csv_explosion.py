...
# Function for generating the fuse animation.
def generate_fuse(counter, x_positions, writer):
    light_number = 0
    current_counter = counter[0]
    while counter[0] <= current_counter + len(x_positions)-3:
        colours = [0 for j in range(len(x_positions)*3)]
        colours[light_number] = 255
        colours[light_number+1] = 212
        colours[light_number+2] = 36
        colours[light_number+3] = 255
        colours[light_number+4] = 212
        colours[light_number+5] = 36
        colours[light_number+6] = 255
        colours[light_number+7] = 212
        colours[light_number+8] = 36
        light_number += 3
        colours = counter + colours
...
# Read in the coordinates of the lights.
x_positions = []
y_positions = []
z_positions = []
